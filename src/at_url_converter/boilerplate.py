...
def get_timed_logger(name: str = "", level: str | int = logging.WARNING, handler: Optional[Literal[True] | logging.Handler] = None) -> TimedLoggerAdapter:
    '''
